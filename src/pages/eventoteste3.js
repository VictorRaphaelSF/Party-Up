...
export default function Eventoteste3({ navigation }) {
  ...
  const [numCurtida, setNumCurtida] = useState(43);
  const [numPresence, setNumPresence] = useState(11);
        ...
        <Navbuttons /* siteInfo={siteInfo} id={id} idEvent={idEvento} numCurtida={numCurtida} setNumCurtida={setNumCurtida} numPresence={numPresence} setNumPresence={setNumPresence} */ />
          ...
          <View style={styles.overlay}>
            <View style={styles.descricaoContainer}>
              ...
              <Text style={styles.descricaoTexto}>{descricao}Nam quis nulla. Integer malesuada. In in enim a arcu imperdiet malesuada. Sed vel lectus. Donec odio urna, tempus molestie, porttitor ut, iaculis quis, sem. Phasellus rhoncus. Aenean id metus id velit ullamcorper pulvinar. Vestibulum fermentum tortor id m</Text>
            </View>
          </View>
          ...
          <View style={styles.dataContainer}>
            ...
            <Text style={styles.dataTexto}>
              Entre {dataInicio}13/12 - {dataFim}14/12
            </Text>
            <Text style={styles.dataTexto2}>
              {horaInicio}16h00 - {horaFim}23h00 - Entrada Padrão
            </Text>
          </View>
          ...
          <View style={styles.siteInfoContainer}>
            ...
            <Text style={styles.siteInfoTexto}>{siteInfo}https://loremipsum.com.br</Text>
          </View>

          <View style={styles.tagsContainer}>
            <Text style={styles.tagsTitulo}>Tags Relacionadas</Text>
            <Text style={styles.tagsTexto}>{tags}Rock, Metal</Text>
          </View>
          ...
          <ImageBackground
            source={require("../assets/images/Eventos(Temporarios)/EventoM(3).png")}
            resizeMode="cover"
            style={styles.square}>
